...
write.table(
  peaks.sig,
  file = file.path("Z_Matrices", paste0(meth, ".", tag, ".Mask.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
...
write.table(
  ...
  file = file.path("Z_Matrices", "PeakCounts_HardMask", paste0(meth, ".", tag, ".PeakCounts_HardMask.Raw.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
...
write.table(
  peak.counts.tpm,
  file = file.path("Z_Matrices", "PeakCounts_HardMask", paste0(meth, ".", tag, ".PeakCounts_HardMask.TPM.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
...
write.table(
  ...
  file = file.path("Z_Matrices", "PeakCounts_HardMask", paste0(meth, ".", tag, ".PeakCounts_HardMask.Normalized.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
...
write.table(
  ...
  file = file.path("Z_Matrices", "PeakCounts_HardMask", paste0(meth, ".", tag, ".PeakCounts_HardMask.Adjusted.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
