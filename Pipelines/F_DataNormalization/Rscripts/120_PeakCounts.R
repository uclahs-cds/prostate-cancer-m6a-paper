...
write.table(
  ...
  file = file.path("Z_Matrices", "PeakCounts", paste0(meth, ".", tag, ".PeakCounts.Raw.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
...
write.table(
  peak.counts.tpm,
  file = file.path("Z_Matrices", "PeakCounts", paste0(meth, ".", tag, ".PeakCounts.TPM.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
...
write.table(
  ...
  file = file.path("Z_Matrices", "PeakCounts", paste0(meth, ".", tag, ".PeakCounts.Normalized.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
...
write.table(
  ...
  file = file.path("Z_Matrices", "PeakCounts", paste0(meth, ".", tag, ".PeakCounts.Adjusted.tsv")),
  sep = "\t",
  col.names = T,
  row.names = T,
  quote = F
