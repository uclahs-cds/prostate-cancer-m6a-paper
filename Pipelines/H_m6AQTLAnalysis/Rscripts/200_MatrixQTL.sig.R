...
output_file_name_cis = paste0("results/", meth, ".", tag, ".", output_tag, ".", n_components, ".MatrixQTL.cis.sig.tsv")
output_file_name_tra = paste0("results/",  meth, ".", tag, ".", output_tag, ".", n_components, ".MatrixQTL.trans.sig.tsv")
...
pvOutputThreshold_tra = if(output_tag == 'CPCGENE_RiskSNPs.final') 1e-2 else 0 #
...
save(me, file = paste0("results/",  meth, ".", tag, ".", output_tag, ".", n_components, ".sig.rsav"))
