...
filename = paste0("~/figures/", meth, ".", tag, ".", output.tag, "_",  n_components, ".RNA.corrected.pdf")
...
rna.results = cbind.data.frame(sig.results[,c("snps", "gene", "GeneName", "Literature")], rna.results)
...
save(rna.results, file = paste0("results/", meth, ".",  tag, ".", output.tag, ".", n_components, ".MatrixQTL.cis.sig.RNA.rsav"))
